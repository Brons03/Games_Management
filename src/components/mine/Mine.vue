        ...
        <div class="mine-asize">
            <el-card class="box-card" style="margin-left: 90px;">
                ...
                <div class="item" @click="change(1)" :style="{'color':which==1?'rgb(70, 139, 218)':''}" v-if="ismine">
                    <span><i class="el-icon-s-flag" ></i><span style="margin-left:20px">历史</span></span> 
                </div>
                 <el-divider  v-if="ismine"></el-divider>
                <div class="item" @click="change(2)" :style="{'color':which==2?'rgb(70, 139, 218)':''}"  v-if="ismine">
                    <span><i class="el-icon-user-solid"></i><span style="margin-left:20px">组队</span></span>
                </div>
                <el-divider  v-if="ismine"></el-divider>
                <div class="item" @click="change(3)" :style="{'color':which==2?'rgb(70, 139, 218)':''}"  v-if="ismine">
                    <span><i class="el-icon-star-on"></i><span style="margin-left:20px">关注</span></span>
                </div>
                <el-divider  v-if="ismine"></el-divider>
                <div class="item" @click="change(4)" :style="{'color':which==3?'rgb(70, 139, 218)':''}"  v-if="ismine">
                    <span><i class="el-icon-s-claim"></i><span style="margin-left:20px">收藏</span></span>
                </div>
            </el-card>
        </div>
