  ...
  <div>
    ...
    <el-row style="height: calc(100vh - 140px);">
      ...
      <el-dialog
        ...
        <div style="margin-top: 20px">
          <file-upload @onUpload="uploadFile" ref="fileUpload" style="margin-top: 5px"></file-upload>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
          ...
          type: 'warning'
            ...
            this.$axios
              .post('/api/admin/content/article', {
                ...
                articleFiles: this.article.articleFiles
              }).then(resp => {
      ...
      uploadFile () {
         this.article.articleFiles = this.$refs.fileUpload.fileList
      }
    }
  }
</script>
